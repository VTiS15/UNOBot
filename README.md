...
Improved from [Exium's work](https://top.gg/bot/565305035592957954), this is a bot that incorporates the popular card game, **UNO**,  into your Discord server, because public bots suck.\
...
`/u.rules` | `/u.r` | None | https://www.unorules.com/
...
# Similar Project
* [UNOBot by Exium](https://top.gg/bot/565305035592957954): The inspiration of this bot. It works in almost the exact same way as this bot does. However, it only features the original game of UNO!. It's a public bot and the crux of the matter is that it suffers from lags, bugs, and downtime often. It's what pushed me to create this bot.
